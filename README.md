...
This original extension is forked from [TheColorRed/vscode-laravel-artisan](https://github.com/TheColorRed/vscode-laravel-artisan) and continues with active maintenance and improvements.
